        ...
        const update = () => {
            ...
            setTimeout(() => {
                ...
                if(vehicleNumber <= 50){
                    ...
                    this.currentTrafficDataKZD.PKW.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataKZD.PKW.durchschnittsgeschwindigkeit, this.currentTrafficDataKZD.PKW.anzahl);
                    this.currentTrafficDataLZD.PKW.anzahl++;
                    this.currentTrafficDataLZD.PKW.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataLZD.PKW.durchschnittsgeschwindigkeit, this.currentTrafficDataLZD.PKW.anzahl);
                }else if(vehicleNumber <= 60){
                    this.currentTrafficDataKZD.KRAD.anzahl++;
                    this.currentTrafficDataKZD.KRAD.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataKZD.KRAD.durchschnittsgeschwindigkeit, this.currentTrafficDataKZD.KRAD.anzahl);
                    this.currentTrafficDataLZD.KRAD.anzahl++;
                    this.currentTrafficDataLZD.KRAD.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataLZD.KRAD.durchschnittsgeschwindigkeit, this.currentTrafficDataLZD.KRAD.anzahl);
                }else if(vehicleNumber <= 70){
                    this.currentTrafficDataKZD.LFW.anzahl++;
                    this.currentTrafficDataKZD.LFW.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataKZD.LFW.durchschnittsgeschwindigkeit, this.currentTrafficDataKZD.LFW.anzahl);
                    this.currentTrafficDataLZD.LFW.anzahl++;
                    this.currentTrafficDataLZD.LFW.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataLZD.LFW.durchschnittsgeschwindigkeit, this.currentTrafficDataLZD.LFW.anzahl);
                } else if(vehicleNumber <= 80){
                    this.currentTrafficDataKZD.PKWA.anzahl++;
                    this.currentTrafficDataKZD.PKWA.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataKZD.PKWA.durchschnittsgeschwindigkeit, this.currentTrafficDataKZD.PKWA.anzahl);
                    this.currentTrafficDataLZD.PKWA.anzahl++;
                    this.currentTrafficDataLZD.PKWA.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataLZD.PKWA.durchschnittsgeschwindigkeit, this.currentTrafficDataLZD.PKWA.anzahl);
                }
                else if(vehicleNumber <= 85){
                    this.currentTrafficDataKZD.LKWA.anzahl++;
                    this.currentTrafficDataKZD.LKWA.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataKZD.LKWA.durchschnittsgeschwindigkeit, this.currentTrafficDataKZD.LKWA.anzahl);
                    this.currentTrafficDataLZD.LKWA.anzahl++;
                    this.currentTrafficDataLZD.LKWA.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataLZD.LKWA.durchschnittsgeschwindigkeit, this.currentTrafficDataLZD.LKWA.anzahl);
                }
                else if(vehicleNumber <= 90){
                    this.currentTrafficDataKZD.LKW.anzahl++;
                    this.currentTrafficDataKZD.LKW.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataKZD.LKW.durchschnittsgeschwindigkeit, this.currentTrafficDataKZD.LKW.anzahl);
                    this.currentTrafficDataLZD.LKW.anzahl++;
                    this.currentTrafficDataLZD.LKW.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataLZD.LKW.durchschnittsgeschwindigkeit, this.currentTrafficDataLZD.LKW.anzahl);
            }
                else if(vehicleNumber <= 95){
                    this.currentTrafficDataKZD.SATTEL.anzahl++;
                    this.currentTrafficDataKZD.SATTEL.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataKZD.SATTEL.durchschnittsgeschwindigkeit, this.currentTrafficDataKZD.SATTEL.anzahl);
                    this.currentTrafficDataLZD.SATTEL.anzahl++;
                    this.currentTrafficDataLZD.SATTEL.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataLZD.SATTEL.durchschnittsgeschwindigkeit, this.currentTrafficDataLZD.SATTEL.anzahl);
                }
                else if(vehicleNumber <= 98){
                    this.currentTrafficDataKZD.BUS.anzahl++;
                    this.currentTrafficDataKZD.BUS.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataKZD.BUS.durchschnittsgeschwindigkeit, this.currentTrafficDataKZD.BUS.anzahl);
                    this.currentTrafficDataLZD.BUS.anzahl++;
                    this.currentTrafficDataLZD.BUS.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataLZD.BUS.durchschnittsgeschwindigkeit, this.currentTrafficDataLZD.BUS.anzahl);
                }
                else{
                    this.currentTrafficDataKZD.SONST.anzahl++;
                    this.currentTrafficDataKZD.SONST.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataKZD.SONST.durchschnittsgeschwindigkeit, this.currentTrafficDataKZD.SONST.anzahl);
                    this.currentTrafficDataLZD.SONST.anzahl++;
                    this.currentTrafficDataLZD.SONST.durchschnittsgeschwindigkeit = this.updateAverageSpeed(this.currentTrafficDataLZD.SONST.durchschnittsgeschwindigkeit, this.currentTrafficDataLZD.SONST.anzahl);
                }
                update();
            }, randomTime);
        }
